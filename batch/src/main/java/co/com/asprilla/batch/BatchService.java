...
public class BatchService {
    ...
    public void executeBatchProcess() {
        ...
        try {
            ...
            // Puedes configurar la URL en application.properties o hardcodearla
            String orchestratorUrl = "http://host.docker.internal:9000/orchestrator/parallel-responses";
